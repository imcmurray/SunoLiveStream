...
test("among several active broadcasts, the most-recently-started wins (stale test broadcast lingering)", () => {
  const live = (id, chat, actualStartTime) =>
    ({ id, status: { lifeCycleStatus: "live" }, snippet: { liveChatId: chat, actualStartTime } });
  const r = chooseBroadcast([
    live("STALE", "cStale", "2026-06-10T02:00:00Z"),
    live("FRESH", "cFresh", "2026-07-04T18:00:00Z"),
  ], []);
